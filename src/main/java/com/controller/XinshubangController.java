...
public class XinshubangController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XinshubangEntity xinshubang, HttpServletRequest request){
        EntityWrapper<XinshubangEntity> ew = new EntityWrapper<XinshubangEntity>();
		PageUtils page = xinshubangService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xinshubang), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R list( XinshubangEntity xinshubang){
       	EntityWrapper<XinshubangEntity> ew = new EntityWrapper<XinshubangEntity>();
      	ew.allEq(MPUtil.allEQMapPre( xinshubang, "xinshubang")); 
        return R.ok().put("data", xinshubangService.selectListView(ew));
    }
     ...
     */
    @RequestMapping("/save")
    public R save(@RequestBody XinshubangEntity xinshubang, HttpServletRequest request){
    ...
    public R update(@RequestBody XinshubangEntity xinshubang, HttpServletRequest request){
        //ValidatorUtils.validateEntity(xinshubang);
        xinshubangService.updateById(xinshubang);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<XinshubangEntity> wrapper = new EntityWrapper<XinshubangEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = xinshubangService.selectCount(wrapper);
