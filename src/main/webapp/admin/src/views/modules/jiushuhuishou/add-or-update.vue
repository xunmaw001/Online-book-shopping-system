          ...
          <el-form-item class="input" label="回收价" prop="huishoujia">
              <el-input v-model="ruleForm.huishoujia" 
                placeholder="回收价" readonly></el-input>
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="回收详情" prop="huishouxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.huishouxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huishouxiangqing" label="回收详情" prop="huishouxiangqing">
                    <span v-html="ruleForm.huishouxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
            ...
            ruleForm: {
                	        huishoumingcheng: '',
                                      ...
                                      leibieOptions: [],
                                                                                          rules: {
                  huishoumingcheng: [
                            { required: true, message: '回收名称不能为空', trigger: 'blur' },
                                    	                                                              ],
                  leibie: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huishoujia = true;
            continue;
	            	            ...
	            	            if(o=='huishouxiangqing'){
            this.ruleForm.huishouxiangqing = obj[o];
	    this.ro.huishouxiangqing = true;
            continue;
          }
	                    }
                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiushuhuishou/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiushuhuishouCrossAddOrUpdateFlag = false;
                  this.parent.search();
